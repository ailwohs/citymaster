...
local changeYourJobWeed = {
  {name="Pole Emploi", colour=15, id=351, x=1269.73, y=-1710.25, z=54.7715},
}

local jobs = {
	{name="Dealer de Weed", id=10},
}
...
function IsNearJobs()
  ...
  for _, item in pairs(changeYourJobWeed) do
