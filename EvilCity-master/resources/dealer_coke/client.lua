...
local changeYourJobCoke = {
  {name="Pole Emploi", colour=15, id=351, x=-1606.77, y=5203.12, z=4.31009},
}

local jobs = {
	{name="Dealer de Coke", id=12},
}
...
function IsNearJobs()
  ...
  for _, item in pairs(changeYourJobCoke) do
