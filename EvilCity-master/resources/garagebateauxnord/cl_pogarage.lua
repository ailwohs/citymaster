...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		DrawMarker(1, 1338.91, 4224.81, 33.9156, 0, 0, 0, 0, 0, 0, 2.001, 2.0001, 0.5001, 0, 155, 255, 200, 0, 0, 0, 0)
		-- Affiche Marqueur pour faire spawn
		if GetDistanceBetweenCoords(1338.91, 4224.81, 33.9156, GetEntityCoords(LocalPed())) < 2 then
...
AddEventHandler('peche:bateau', function()
	...
	local spawned_car = CreateVehicle(vehicle, coords, 1351.39, 4225.16, 29.2834, true, false)
